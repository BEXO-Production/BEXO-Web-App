/** Canonical BEXO brand strings — keep in sync with api-server/src/lib/brand.ts */

/** Exact OAuth consent screen / Google Auth Platform app name */
export const BEXO_OAUTH_APP_NAME = "BEXO From Ace Digital";
