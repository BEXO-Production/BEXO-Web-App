...
export default function Step7Payment() {
  ...
  return (
    <div className="flex flex-col h-full justify-center max-w-lg w-full mx-auto pb-10">
      <div className="mb-8 text-center">
        ...
        <p className="text-slate-500 text-base md:text-lg">
          Choose a plan to publish your site and unlock premium features.
        </p>
      </div>
      ...
      <div className="mt-8">
        ...
        >
          {isProcessing ? (
            ...
            <>
              {tab === 'pay' ? `Proceed to Pay ${plan === 'annual' ? '₹499' : '₹1,999'}` : 'Activate Account'}
