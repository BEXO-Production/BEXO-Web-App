...
async function main() {
  ...
  await client.query(`
    ...
    VALUES
      ...
      ('identity', 'Identity Plan', 'Your professional identity, live', 59, 52428800, true, 1, false, '["yourname subdomain","Premium templates","50MB cloud storage","1 AI resume parse / month","3 updates / month","Monthly invoice in dashboard"]'::jsonb, true, 'monthly', 1, 3, 'plan_TG5sccGNDClMmo'),
      ('essential', 'Essential Plan', 'Everything in Identity, more room to grow', 199, 104857600, true, 2, true, '["Everything in Identity","100MB cloud storage","3 AI resume parses / month","10 updates / month","Access to exclusive templates"]'::jsonb, true, 'monthly', 3, 10, 'plan_TG5sd0bp8lk8LH'),
      ('growth', 'Growth Plan', 'Essential, billed yearly', 999, 104857600, true, 3, false, '["Everything in Essential","Billed once a year","100MB cloud storage","3 AI resume parses / month","10 updates / month"]'::jsonb, true, 'yearly', 3, 10, 'plan_TG5sdCcFb3Kz8T'),
      ...
      ('storage_addon', 'Storage Increase', '+50MB per block, billed monthly', 25, 52428800, true, 99, false, '["+50MB per block on top of your base plan","Billed monthly via Razorpay Autopay","Cancel anytime"]'::jsonb, true, 'monthly', 0, 0, 'plan_TG5sdNqyXhFgtM')
